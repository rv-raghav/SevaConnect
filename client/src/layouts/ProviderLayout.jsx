...
const NAV_ITEMS = [
  ...
  { to: "/provider/profile", icon: "person", label: "My Profile" },
];
      ...
      <div className="px-4 pb-4">
        <div className="bg-primary/6 rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-slate-900 text-xs font-bold">Need Help?</p>
          </div>
          <p className="text-slate-500 text-xs leading-relaxed mb-3">
            Our support team is available 24/7 to assist you.
          </p>
          <button className="w-full py-2 bg-primary text-white text-xs font-bold rounded-xl hover:bg-primary/90 transition-colors">
            Contact Support
          </button>
        </div>
      </div>
